(function($){
	...
	$(window).on('elementor/frontend/init', function () {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/remons_elementor_pricing_tab.default', function(){
			...
			$(".ova-pricing-tab .tab-pricing-switch .switch").each(function(){
                ...
                that.on( 'click', function() {
                	...
                	if ( active == 'pricing-tab1' ) {
                		active = 'pricing-tab2';
                		that.addClass('switch-active');
                	} else {
                		active = 'pricing-tab1';
                		that.removeClass('switch-active');
                	};
