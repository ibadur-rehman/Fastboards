 ...
 */
class Remons_Elementor_Blog_2 extends \Elementor\Widget_Base {
	
	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'remons_elementor_blog_2';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 2', 'remons' );
	}
	...
	public function get_style_depends() {
		wp_enqueue_style( 'remons-elementor-blog-2', REMONS_URI.'/assets/scss/elementor/blogs/blog-2.css' );
		return [];
	}
	...
	protected function register_controls() {
			...
			'general',
			  	...
			  	$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2' => 'gap: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item' => 'margin-top: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'selectors' => [
						    '{{WRAPPER}} .ova-blog-2 .item' => 'background-color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	...
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	 ]
				);
			  	...
			  	$this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-2 .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
			  	);
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item .media .box-img img' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .media .box-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .media .box-img img',
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .media .post-meta', 
					]
				);
			    ...
			    $this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-2 .item .media .post-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'type' 		=> \Elementor\Controls_Manager::COLOR,
					    'selectors' => [
					    	'{{WRAPPER}} .ova-blog-2 .item .media .post-meta .post-comment' => 'color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_control(
				  	...
				  	[
					  	...
					  	'type' 		=> \Elementor\Controls_Manager::COLOR,
					  	'selectors' => [
						  	'{{WRAPPER}} .ova-blog-2 .item .media .post-meta .separator-icon' => 'color : {{VALUE}};',
					  	],
				  	]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item .media .post-meta .separator-icon' => 'font-size: {{SIZE}}{{UNIT}};',
						],
					]
				);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .content .post-title',  
					]
				);
				...
				$this->add_control(
					  ...
					  [
						  ...
						  'type' 		=> \Elementor\Controls_Manager::COLOR,
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-2 .item .content .post-title a' => 'color : {{VALUE}};',
						  ],
					  ]
				);
				...
				$this->add_control(
					  ...
					  [
						  ...
						  'type' 		=> \Elementor\Controls_Manager::COLOR,
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-2 .item:hover .content .post-title a' => 'color : {{VALUE}};',
						  ],
					  ]
				);
				...
				$this->add_responsive_control(
					  ...
					  [
						  ...
						  'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-2 .item .content .post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						  ],
					  ]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .content .post-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .content .short_desc p',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							  '{{WRAPPER}} .ova-blog-2 .short_desc p' => 'color : {{VALUE}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .content .short_desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .content .short_desc' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);  
		   	...
		   	$this->start_controls_section(
		  		...
		  		$this->add_control(
					...
					[
						...
						'toggle' 	=> true,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item .media .box-img .post-date' => ' right:unset ; {{VALUE}} : 20px',
						],
					]
				);
			  	...
			  	$this->add_group_control(
				  	...
				  	[
					  	...
					  	'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .post-date', 
				  	]
			  	);
				...
				$this->start_controls_tabs(
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-2 .item .media .post-date' => 'color : {{VALUE}};',
						  	],
					  	]
				  	);
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-2 .item .post-date' => 'background-color : {{VALUE}};',
						  	],
					  	]
				 	);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-2 .item:hover .media .post-date' => 'color : {{VALUE}};',
							  	],
						  	]
					  	);
					  	...
					  	$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-2 .item:hover .post-date' => 'background-color : {{VALUE}};',
							  	],
						  	]
						);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .media .post-category',  
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item .media .post-category' => 'color : {{VALUE}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .media .post-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
		    ...
		    $this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
					  ...
					  'selector' 	=> '{{WRAPPER}} .ova-blog-2 .item .content .read-more',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-2 .item .content .read-more i' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .ova-blog-2 .item .content .read-more svg' => 'width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .content .read-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			  	...
			  	$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-2 .item .content .read-more' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-2 .item .content .read-more' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-2 .item .content .read-more i' => 'color : {{VALUE}};',
								],
							]
						);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-2 .item .content .read-more:hover' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-2 .item .content .read-more:hover i' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_group_control(
                            \Elementor\Group_Control_Background::get_type(),
                            [
                                'name'         => 'background_hover_button_read_more',
                                'types'     => [ 'classic', 'gradient'],
                                'selector'     => '{{WRAPPER}} .ova-blog-2 .item .content .read-more:hover',
                            ]
                        );
		 ...
		 */
	  	protected function render() {
			...
			// Get the current page number from the URL, defaults to 1 if none
			...
			<div class="blog-container" 
				data-template_id= "blog-2"
	            data-widget-settings='<?php echo json_encode( $settings ); ?>'>
				<div class="ova-blog-2 <?php echo esc_attr( $number_column ); ?>" >
										...
										if( 'yes' === $show_comment ) : ?>
											<div class="post-comment">
												<span class="comment-count">
													<?php echo sprintf( esc_html__( 'Comments (%s)', 'remons' ), get_comments_number( $blog_id ) ); ?>
												</span>
											</div>
										<?php endif; ?>
									</div>
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Blog_2() );