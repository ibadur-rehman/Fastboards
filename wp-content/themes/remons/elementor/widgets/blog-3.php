 ...
 */
class Remons_Elementor_Blog_3 extends \Elementor\Widget_Base {
	
	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'remons_elementor_blog_3';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 3', 'remons' );
	}
	...
	public function get_style_depends() {
		wp_enqueue_style( 'remons-elementor-blog-3', REMONS_URI.'/assets/scss/elementor/blogs/blog-3.css' );
		return [];
	}
	...
	protected function register_controls() {
			...
			'general',
			  	...
			  	$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3' => 'gap: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item' => 'margin-top: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'selectors' => [
						    '{{WRAPPER}} .ova-blog-3 .item' => 'background-color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	...
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	 ]
				);
			  	...
			  	$this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-3 .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
			  	);
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item .media .box-img img' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .media .box-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .media .box-img',
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .content .post-meta',
					]
				);
			    ...
			    $this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-3 .item .content .post-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'type' 		=> \Elementor\Controls_Manager::COLOR,
					    'selectors' => [
					    	'{{WRAPPER}} .ova-blog-3 .item .content .post-meta .post-comment' => 'color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_control(
				  	...
				  	[
					  	...
					  	'type' 		=> \Elementor\Controls_Manager::COLOR,
					  	'selectors' => [
						  	'{{WRAPPER}} .ova-blog-3 .item .content .post-meta .separator-icon' => 'color : {{VALUE}};',
					  	],
				  	]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item .content .post-meta .separator-icon' => 'font-size: {{SIZE}}{{UNIT}};',
						],
					]
				);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .content .post-title',  
					]
				);
				...
				$this->add_control(
					  ...
					  [
						  ...
						  'type' 		=> \Elementor\Controls_Manager::COLOR,
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-3 .item .content .post-title a' => 'color : {{VALUE}};',
						  ],
					  ]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 			=> \Elementor\Controls_Manager::COLOR,
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item:hover .content .post-title a' => 'color : {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					  ...
					  [
						  ...
						  'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-3 .item .content .post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						  ],
					  ]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .post-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .content .short_desc p',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							  '{{WRAPPER}} .ova-blog-3 .short_desc p' => 'color : {{VALUE}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .short_desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .short_desc' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);  
		   	...
		   	$this->start_controls_section(
		  		...
		  		$this->add_control(
					...
					[
						...
						'toggle' 	=> true,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item .media .post-date' => ' right:unset ; {{VALUE}} : -44px',
						],
					]
				);
			  	...
			  	$this->add_group_control(
				  	...
				  	[
					  	...
					  	'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .post-date', 
				  	]
			  	);
			  	...
			  	$this->start_controls_tabs(
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-3 .item .media .post-date' => 'color : {{VALUE}};',
						  	],
					  	]
				  	);
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-3 .item .post-date' => 'background-color : {{VALUE}};',
						  	],
					  	]
				 	);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-3 .item:hover .media .post-date' => 'color : {{VALUE}};',
							  	],
						  	]
					  	);
					  	...
					  	$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-3 .item:hover .post-date' => 'background-color : {{VALUE}};',
							  	],
						  	]
						);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .content .post-category',  
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item .content .post-category' => 'color : {{VALUE}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .post-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
		    ...
		    $this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
					  ...
					  'selector' 	=> '{{WRAPPER}} .ova-blog-3 .item .content .read-more',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-3 .item .content .read-more i' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .ova-blog-3 .item .content .read-more svg' => 'width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .read-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			  	...
			  	$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-3 .item .content .read-more' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-3 .item .content .read-more' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-3 .item .content .read-more i' => 'color : {{VALUE}};',
								],
							]
						);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-3 .item .content .read-more:hover' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ova-blog-3 .item .content .read-more:hover i' => 'color : {{VALUE}};',
								],
							]
						);
						...
						$this->add_group_control(
                            ...
                            [
                                ...
                                'types'     => [ 'classic', 'gradient'],
                                'selector'     => '{{WRAPPER}} .ova-blog-3 .item .content .read-more:hover',
                            ]
                        );
		 ...
		 */
	  	protected function render() {
			...
			// Get the total number of result pages (for pagination)
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Blog_3() );