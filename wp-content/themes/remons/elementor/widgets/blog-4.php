 ...
 */
class Remons_Elementor_Blog_4 extends \Elementor\Widget_Base {
	
	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'remons_elementor_blog_4';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog 4', 'remons' );
	}
	...
	public function get_style_depends() {
		wp_enqueue_style( 'remons-elementor-blog-4', REMONS_URI.'/assets/scss/elementor/blogs/blog-4.css' );
		return [];
	}
	...
	protected function register_controls() {
			...
			'general',
			  	...
			  	$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4' => 'gap: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4 .item' => 'margin-top: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'selectors' => [
						    '{{WRAPPER}} .ova-blog-4 .item' => 'background-color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	...
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-4 .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	 ]
				);
			  	...
			  	$this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-4 .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
			  	);
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4 .item .media .box-img img' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
				  	...
				  	[
					 	...
					 	'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-4 .item .media .box-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				 	]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-4 .item .media .box-img',
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-4 .item .content .post-meta',  
					]
				);
			    ...
			    $this->add_responsive_control(
				  	...
				  	[
					  	...
					  	'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
					  	'selectors' 	=> [
						  	'{{WRAPPER}} .ova-blog-4 .item .content .post-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					  	],
				  	]
				);
				...
				$this->add_control(
				    ...
				    [
					    ...
					    'type' 		=> \Elementor\Controls_Manager::COLOR,
					    'selectors' => [
					    	'{{WRAPPER}} .ova-blog-4 .item .content .post-meta .post-comment' => 'color : {{VALUE}};',
					    ],
				    ]
				);
				...
				$this->add_control(
				  	...
				  	[
					  	...
					  	'type' 		=> \Elementor\Controls_Manager::COLOR,
					  	'selectors' => [
						  	'{{WRAPPER}} .ova-blog-4 .item .content .post-meta .separator-icon' => 'color : {{VALUE}};',
					  	],
				  	]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4 .item .content .post-meta .separator-icon' => 'font-size: {{SIZE}}{{UNIT}};',
						],
					]
				);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-4 .item .content .post-title',  
					]
				);
				...
				$this->add_control(
					  ...
					  [
						  ...
						  'type' 		=> \Elementor\Controls_Manager::COLOR,
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-4 .item .content .post-title a' => 'color : {{VALUE}};',
						  ],
					  ]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 			=> \Elementor\Controls_Manager::COLOR,
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-4 .item:hover .content .post-title a' => 'color : {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					  ...
					  [
						  ...
						  'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						  'selectors' 	=> [
							  '{{WRAPPER}} .ova-blog-4 .item .content .post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						  ],
					  ]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-4 .item .content .post-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
		   	...
		   	$this->start_controls_section(
		  		...
		  		$this->add_control(
					...
					[
						...
						'toggle' 	=> true,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4 .item .media .post-date' => ' right:unset ; {{VALUE}} : 20px',
						],
					]
				);
			  	...
			  	$this->add_group_control(
				  	...
				  	[
					  	...
					  	'selector' 	=> '{{WRAPPER}} .ova-blog-4 .item .post-date', 
				  	]
			  	);
			  	...
			  	$this->start_controls_tabs(
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-4 .item .media .post-date' => 'color : {{VALUE}};',
						  	],
					  	]
				  	);
					...
					$this->add_control(
					  	...
					  	[
						  	...
						  	'type' 		=> \Elementor\Controls_Manager::COLOR,
						  	'selectors' => [
							  	'{{WRAPPER}} .ova-blog-4 .item .post-date' => 'background-color : {{VALUE}};',
						  	],
					  	]
				 	);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-4 .item:hover .media .post-date' => 'color : {{VALUE}};',
							  	],
						  	]
					  	);
					  	...
					  	$this->add_control(
						  	...
						  	[
							  	...
							  	'type' 		=> \Elementor\Controls_Manager::COLOR,
							  	'selectors' => [
								  	'{{WRAPPER}} .ova-blog-4 .item:hover .post-date' => 'background-color : {{VALUE}};',
							  	],
						  	]
						);
		  	...
		  	$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ova-blog-4 .item .media .post-category',  
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ova-blog-4 .item .media .post-category' => 'color : {{VALUE}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ova-blog-4 .item .media .post-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
		...
		<div class="blog-container" 
			data-template_id= "blog-4"
	        data-widget-settings='<?php echo json_encode( $settings ); ?>'>
			<div class="ova-blog-4 <?php echo esc_attr( $number_column ); ?>">
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Blog_4() );