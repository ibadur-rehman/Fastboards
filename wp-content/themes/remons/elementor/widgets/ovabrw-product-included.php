...
/**
 * Class Remons_Elementor_Ovabrw_Product_Included
 */
class Remons_Elementor_Ovabrw_Product_Included extends \Elementor\Widget_Base {

	/**
	 * Get widget name
	 */
	public function get_name() {		
		return 'remons_elementor_ovabrw_product_included';
	}
	...
	public function get_title() {
		return esc_html__( 'Product Included', 'remons' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__('Included in the Price', 'remons'),
				]
			);
	...
	protected function render() {
		...
		?>
		<div class="elementor-ovabrw-product-included">
			<?php ovabrw_get_template( apply_filters( 'remons_widget_template_product_included', 'single/included.php', $settings ), [
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Ovabrw_Product_Included() );