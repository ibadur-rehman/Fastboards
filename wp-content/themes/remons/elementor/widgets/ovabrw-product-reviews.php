...
/**
 * Class Remons_Elementor_Ovabrw_Product_Reviews
 */
class Remons_Elementor_Ovabrw_Product_Reviews extends \Elementor\Widget_Base {

	/**
	 * Get widget name
	 */
	public function get_name() {		
		return 'remons_elementor_ovabrw_product_reviews';
	}
	...
	public function get_title() {
		return esc_html__( 'Product Reviews', 'remons' );
	}
	...
	protected function render() {
		...
		<div class="elementor-reviews">
			<?php ovabrw_get_template( apply_filters( 'remons_widget_template_product_reviews', 'single/review.php', $settings ), [
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Ovabrw_Product_Reviews() );