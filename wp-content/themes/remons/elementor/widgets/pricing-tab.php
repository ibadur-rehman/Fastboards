...
class Remons_Elementor_Pricing_Tab extends Widget_Base {

	public function get_name() {
		return 'remons_elementor_pricing_tab';
	}

	public function get_title() {
		return esc_html__( 'Pricing Tab', 'remons' );
	}
	...
	public function get_script_depends() {
		wp_enqueue_script( 'remons-elementor-pricing-tab', REMONS_URI.'/assets/js/elementor/pricing-tab.js' );
		return [];
	}
	...
	public function get_style_depends() {
		wp_enqueue_style( 'remons-elementor-pricing-tab', REMONS_URI.'/assets/scss/elementor/pricing-tab/pricing-tab.css' );
		return [];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'show_package_yearly',
				[
					'label' 		=> esc_html__( 'Show Package Yearly', 'remons' ),
		    ...
		    $this->add_control(
				...
				[
					...
					'default' => esc_html__( 'Monthly', 'remons' ),
				]
			);
			...
			$this->add_control(
	            'tab_content_month',
	            [
	                'label' => esc_html__( 'Shortcode Pricing 1', 'remons' ),     
	                'type' => Controls_Manager::TEXTAREA,
	                'description' => esc_html__( 'Shortcode Pricing', 'remons' ),
	            ]
	        );
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Label', 'remons' ),
					'type' => Controls_Manager::TEXT,
					'default' => esc_html__( 'Yearly', 'remons' ),
					'condition' 	=> [
						'show_package_yearly' => 'yes',
					],
				]
			);
			...
			$this->add_control(
	            'tab_content_year',
	            [
	                'label' => esc_html__( 'Shortcode Pricing 2', 'remons' ),
	                'type' => Controls_Manager::TEXTAREA,
	                'description' => esc_html__( 'Shortcode Pricing 2', 'remons' ),
	                'condition' 	=> [
						'show_package_yearly' => 'yes',
					],
	            ]
		...
		$this->start_controls_section(
            'switch_button_style',
            [
                'label' => esc_html__( 'Switch Button', 'remons' ),
                'tab' 	=> Controls_Manager::TAB_STYLE,
            ]
        );
	...
	protected function render() {
		...
		$show_package_yearly = $settings['show_package_yearly'];
		...
		?>
		    ...
		    <div class="ova-pricing-tab">
		    	<?php if( 'yes' === $show_package_yearly ): ?>
...
$widgets_manager->register( new Remons_Elementor_Pricing_Tab() );