 ...
 * @since 1.0.0
 */
class Remons_Elementor_Tabs extends Widget_Tabs {

    public function get_style_depends(): array {
        wp_enqueue_style( 'remons-elementor-tabs', REMONS_URI.'/assets/scss/elementor/tabs/tabs.css' );
        return [ 'widget-tabs' ];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'tab_icon_image',
            [
                'label' => esc_html__( 'Icon/Image', 'remons' ),
                ...
                'options' => [
                    ...
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'remons' ),
                        'icon' => 'eicon-caret-right',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'remons' ),
                        'icon' => 'eicon-image',
                    ],
                ],
                'default'   => 'none',
        ...
        $repeater->add_control(
            'ova_icon',
            [
                'label'     => esc_html__( 'Choose Icon', 'remons' ),
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label' => esc_html__( 'Title & Description', 'remons' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Tab Title', 'remons' ),
                'placeholder' => esc_html__( 'Tab Title', 'remons' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'remons' ),
                'placeholder' => esc_html__( 'Tab Content', 'remons' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'remons' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'remons' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'remons' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'remons' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'remons' ),
                    ],
                ],
        ...
        $this->add_control(
            'type',
            [
                'label' => esc_html__( 'Position', 'remons' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'remons' ),
                    'vertical' => esc_html__( 'Vertical', 'remons' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'stretch' => [
                        'title' => esc_html__( 'Justified', 'remons' ),
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => esc_html__( 'Navigation Width', 'remons' ),
        ...
        $this->add_control(
            'border_width',
            [
                'label' => esc_html__( 'Border Width', 'remons' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 1,
                ],
        ...
        $this->add_control(
            'border_color',
            [
                'label' => esc_html__( 'Border Color', 'remons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'remons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'remons' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'remons' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Hover', 'remons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Width (Active)', 'remons' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'remons' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'remons' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
        ...
        /* End Ova Title Style */
         ...
         /* Begin Ova Subtitle Style */
        $this->start_controls_section(
            'section_ova_subtitle_style',
            [
                'label' => esc_html__( 'Subtitle', 'remons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name'      => 'ova_subtitle_typography',
                    'selector'  => '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title .elementor-tab-subtitle, {{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title .elementor-tab-subtitle',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title .elementor-tab-subtitle' => 'color: {{VALUE}}',
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title .elementor-tab-subtitle' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Active Color', 'remons' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title.elementor-active .elementor-tab-subtitle' => 'color: {{VALUE}}',
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title.elementor-active .elementor-tab-subtitle' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title .elementor-tab-subtitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title .elementor-tab-subtitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

        $this->end_controls_section();
        /* End Ova Subtitle Style */
        ...
        <div <?php $this->print_render_attribute_string( 'elementor-tabs' ); ?>>
            <div class="elementor-tabs-wrapper" role="tablist" >
                ...
                foreach ( $tabs as $index => $item ) :
                    ...
                    $tab_subtitle = '<span class="elementor-tab-subtitle" style="display:block;">' . $item['tab_subtitle'] . '</span>';
                        ...
                        <div {{{ view.getRenderAttributeString( tabTitleKey ) }}}>
                            <#
                                if ( 'icon' === item.tab_icon_image && item.ova_icon.value ) {
                                    ...
                                    {{{ item.tab_title }}}
                                    <span class="elementor-tab-subtitle" style="display:block;">{{{ item.tab_subtitle }}}</span>
...
$widgets_manager->register(new Remons_Elementor_Tabs());