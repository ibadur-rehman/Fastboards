...
/**
 * Class Remons_Elementor_Testimonial
 */
class Remons_Elementor_Testimonial extends \Elementor\Widget_Base {

	/**
	 * Get widget name
	 */
	public function get_name() {
		return 'remons_elementor_testimonial';
	}
	...
	public function get_title() {
		return esc_html__( 'Ova Testimonial', 'remons' );
	}
	...
	public function get_script_depends() {
		return [ 'remons-elementor-testimonial' ];
	}
	...
	public function get_style_depends() {
		wp_enqueue_style( 'remons-elementor-testimonial', REMONS_URI.'/assets/scss/elementor/testimonials/testimonial.css' );
		return [];
	}
		...
		$this->start_controls_section(
            ...
            $this->add_responsive_control(
				...
				[
					...
					'selectors' 	=> [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .client_info' => 'max-width: {{SIZE}}{{UNIT}};',
					],	
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .top_info' => 'background : {{VALUE}};',	
					],
				]
			);
		    ...
		    $this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%', 'rem', 'custom' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .top_info' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%', 'rem', 'custom' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .top_info' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' 	=> [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .client_info .info .client img' => 'width: {{SIZE}}{{UNIT}};min-width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}}',
					],	
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%', 'rem', 'custom' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .client_info .info .client' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .client_info .rating-icon i' => 'margin-right: {{SIZE}}{{UNIT}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .client_info .rating-icon i' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .owl-dots .owl-dot span' => 'width: {{SIZE}}{{UNIT}}; height:{{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' 	=> [
						'{{WRAPPER}} .ova-testimonial .slide-testimonials .owl-dots .owl-dot.active span' => 'width: {{SIZE}}{{UNIT}};',
					],
	...
	?>
		<section class="ova-testimonial ova-testimonial-<?php echo esc_attr( $template ); ?>">
					...
					<div class="item">
						<div class="client_info">
							...
							<?php if ( 'template1' === $template ): ?>
								<div class="info">
									<div class="client">
										<?php if ( '' != remons_get_meta_data( 'image_author', $item ) ): ?>
...
// Register new widget
$widgets_manager->register( new Remons_Elementor_Testimonial() );