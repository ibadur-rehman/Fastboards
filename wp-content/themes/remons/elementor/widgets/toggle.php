 ...
 * @since 1.0.0
 */
class Remons_Elementor_Toggle extends Widget_Toggle {

	public function get_style_depends(): array {
		wp_enqueue_style( 'remons-elementor-toggle', REMONS_URI.'/assets/scss/elementor/toggle/toggle.css' );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Toggle', 'remons' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Title', 'remons' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Content', 'remons' ),
				'show_label' => false,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Toggle Items', 'remons' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Toggle #1', 'remons' ),
					...
					[
						'tab_title' => esc_html__( 'Toggle #2', 'remons' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'remons' ),
					],
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Icon', 'remons' ),
				'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'remons' ),
		...
		$this->add_control(
			'faq_schema',
			[
				'label' => esc_html__( 'FAQ Schema', 'remons' ),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__( 'Space Between', 'remons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius Active', 'remons' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_control(
				'show_before_title',
				[
					'label' 	=> esc_html__( 'Show Before Title', 'remons' ),
            ...
            $this->add_control(
                'ova_before_title',
                [
                    'label'     => esc_html__( 'Before Title Style', 'remons' ),
		...
		$this->add_control(
			'ova_before_icon',
			[
				'label' 	=> esc_html__( 'Before Icon', 'remons' ),
	        ...
	        $this->add_control(
				'show_boxes_icon',
				[
					'label' 	=> esc_html__( 'Show Border Icon', 'remons' ),
					'type' 		=> \Elementor\Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'remons' ),
					'label_off' => esc_html__( 'Hide', 'remons' ),
					'default' 	=> 'no',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin (p, h1... h6)', 'remons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
...
$widgets_manager->register(new Remons_Elementor_Toggle());
