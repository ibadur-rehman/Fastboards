...
if (!class_exists( 'Remons_Customize' )){

	class Remons_Customize {
		
		public function __construct() {
	        add_action( 'customize_register', array( $this, 'remons_customize_register' ) );
	    }

	    public function remons_customize_register($wp_customize) {
	        
	        $this->remons_init_remove_setting( $wp_customize );
	        $this->remons_init_ova_typography( $wp_customize );
	        $this->remons_init_ova_color( $wp_customize );
	        $this->remons_init_ova_layout( $wp_customize );
	        $this->remons_init_ova_header( $wp_customize );
	        $this->remons_init_ova_footer( $wp_customize );
	        $this->remons_init_ova_blog( $wp_customize );
	        
	        if( remons_is_woo_active() ){
	        	$this->remons_init_ova_woo( $wp_customize );	
	        }
	   
	        do_action( 'remons_customize_register', $wp_customize );
	    }

	    public function remons_init_remove_setting( $wp_customize ){
		    ...
		    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'logo', array(
		        'label'    => esc_html__( 'Logo Default', 'remons' ),
	    ...
	    /* Typo */
	    public function remons_init_ova_typography($wp_customize){

	    		/* Body Pane ******************************/
				$wp_customize->add_section( 'typo_general' , array(
				    'title'      => esc_html__( 'Typography', 'remons' ),
				    'priority'   => 1,
				    // 'panel' => 'typo_panel',
				) );
					...
					$wp_customize->add_control(
						new Remons_Customize_Control_Heading( 
						$wp_customize, 
						'text_typo_message', 
						array(
							'label'		=> esc_html__('Text Font','remons'),
						...
						$wp_customize->add_control('general_font_size', array(
							...
							'description' 	=> esc_html__('Example: 16px, 1.2em','remons'),
							'section' 		=> 'typo_general',
						...
						/* Font Weight */
						$wp_customize->add_setting( 'general_font_weight', array(
						  'type' 				=> 'theme_mod', // or 'option'
						  'capability' 			=> 'edit_theme_options',
						  'theme_supports' 		=> '', // Rarely needed.
						  'default' 			=> '300',
						...
						$wp_customize->add_control('general_font_weight', array(
							'label' 		=> esc_html__('Font Weight','remons'),
							'description' 	=> esc_html__('Example: 300, regular','remons'),
							'section' 		=> 'typo_general',
							'settings' 		=> 'general_font_weight',
							'type' 			=>'text'
						));
						...
						$wp_customize->add_control('general_line_height', array(
							'label' 		=> esc_html__('Line height','remons'),
							'description' 	=> esc_html__('Recommend use em. Example: 1.6em, 23px','remons'),
							'section' 		=> 'typo_general',
						...
						$wp_customize->add_control('general_letter_space', array(
							'label' 		=> esc_html__('Letter Spacing','remons'),
							'description' 	=> esc_html__('Example: 0px, 0.5em','remons'),
							'section' 		=> 'typo_general',
				...
				$wp_customize->add_control(
					...
					'general_heading', 
					array(
						'label' 	=> esc_html__('Primary Font','remons'),
			            'section' 	=> 'typo_general',
				...
				$wp_customize->add_setting( 'primary_font',
					array(
						'default' 			=> remons_default_primary_font(),
						'sanitize_callback' => 'remons_google_font_sanitization'
					)
				);
					$wp_customize->add_control( new Remons_Google_Font_Select_Custom_Control( $wp_customize, 'primary_font',
						array(
							'label' 			=> esc_html__( 'Primary Font', 'remons' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
				...
				$wp_customize->add_control(
					...
					'second_font_message', 
					array(
						'label' 	=> esc_html__('Second Font ( Heading )','remons'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_setting( 'second_font',
						array(
							'default' 			=> remons_default_second_font(),
							'sanitize_callback' => 'remons_google_font_sanitization'
						)
					);
					$wp_customize->add_control( new Remons_Google_Font_Select_Custom_Control( $wp_customize, 'second_font',
						array(
							'label' 			=> esc_html__( 'Font', 'remons' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
								'font_count' 	=> 'all',
								'orderby' 		=> 'popular',
					...
					$wp_customize->add_control('heading_font_weight', array(
						'label' 		=> esc_html__('Font Weight','remons'),
						'description' 	=> esc_html__('Example: 600, bold','remons'),
						'section' 		=> 'typo_general',
				...
				$wp_customize->add_control(
					...
					'custom_font_message', 
					array(
						'label' 	=> esc_html__('Custom Font','remons'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_control('ova_custom_font', array(
						...
						'description' 	=> esc_html__('Step 1: Insert font-face in style.css file: Refer https://www.w3schools.com/cssref/css3_pr_font-face_rule.asp. Step 2: Insert font-family and font-weight like format: 
							["Perpetua", "Regular:Bold:Italic:Light"] | ["Name-Font", "Regular:Bold:Italic:Light"]. Step 3: Refresh customize page to display new font in dropdown font field.','remons'),
						'section' 		=> 'typo_general',
	     ...
	     /* Color */
	    public function remons_init_ova_color( $wp_customize ){

	    	/* Body Pane ******************************/
			$wp_customize->add_section( 'color_section' , array(
			    'title'      => esc_html__( 'Color', 'remons' ),
			    'priority'   => 2,
			    // 'panel' => 'typo_panel',
			) );
				...
				$wp_customize->add_setting( 'primary_color', array(
					...
					'theme_supports' 	=> '', // Rarely needed.
					'transport' 		=> 'refresh', // or postMessage
					'default'			=> remons_default_primary_color(),
					'sanitize_callback' => 'sanitize_text_field' // Get function name 
				) );
				$wp_customize->add_control(
					...
					'primary_color', 
					array(
						'label' 	=> esc_html__("Primary",'remons'),
				...
				$wp_customize->add_control(
					...
					'secondary_color', 
					array(
						'label' 	=> esc_html__("Secondary",'remons'),
			            'section' 	=> 'color_section',
	    ...
	    /* Layout */
	    public function remons_init_ova_layout( $wp_customize ){

	    	$wp_customize->add_section( 'layout_section' , array(
			    'title'      => esc_html__( 'Layout', 'remons' ),
			    'priority'   => 2,
			) );
				...
				$wp_customize->add_control('global_boxed_container_width', array(
					'label' 	=> esc_html__('Container (px)','remons'),
				...
				$wp_customize->add_control('global_layout', array(
					...
					'type' 		=> 'select',
					'choices' 	=> apply_filters( 'remons_define_layout', array() )
				));
				...
				$wp_customize->add_control('global_sidebar_width', array(
					'label' 	=> esc_html__('Sidebar Width (px)','remons'),
					'section' 	=> 'layout_section',
				...
				$wp_customize->add_control('global_wide_site', array(
					'label' 	=> esc_html__('Wide Site','remons'),
					'section' 	=> 'layout_section',
					'settings' 	=> 'global_wide_site',
					'type' 		=> 'select',
					'choices' 	=> apply_filters( 'remons_define_wide_boxed', array() )
				));
				...
				$wp_customize->add_control('global_boxed_offset', array(
					'label' 	=> esc_html__('Boxed Offset (px)','remons'),
					'section' 	=> 'layout_section',
	    ...
	    /* Header */
	    public function remons_init_ova_header( $wp_customize ){

	    	$wp_customize->add_section( 'header_section' , array(
			    'title'      => esc_html__( 'Header', 'remons' ),
			    'priority'   => 3,
			) );
				...
				$wp_customize->add_control('global_header', array(
					'label' 		=> esc_html__('Header Default','remons'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'remons'),
					'section' 		=> 'header_section',
					'settings' 		=> 'global_header',
					'type' 			=> 'select',
					'choices' 		=> apply_filters( 'remons_list_header', array() )
				));
	    }

	    /* Footer */
	    public function remons_init_ova_footer( $wp_customize ){

	    	$wp_customize->add_section( 'footer_section' , array(
			    'title'      => esc_html__( 'Footer', 'remons' ),
			    'priority'   => 4,
			) );
				...
				$wp_customize->add_control('global_footer', array(
					'label' 		=> esc_html__('Footer Default','remons'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'remons'),
					'section' 		=> 'footer_section',
					'settings' 		=> 'global_footer',
					'type' 			=> 'select',
					'choices' 		=> apply_filters( 'remons_list_footer', array() )
				));
	    }


	    /* Blog */
	    public function remons_init_ova_blog( $wp_customize ){

	    	$wp_customize->add_panel( 'blog_panel', array(
			    'title'		=> esc_html__( 'Blog', 'remons' ),
			    'priority' 	=> 5,
			) );

				$wp_customize->add_section( 'blog_section' , array(
				    'title' 	=> esc_html__( 'Archive', 'remons' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );
					...
					$wp_customize->add_control('blog_archive_show_media', array(
						'label' 	=> esc_html__('Show Media','remons'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_header', array(
						'label' 	=> esc_html__('Header','remons'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_footer', array(
						'label' 	=> esc_html__('Footer','remons'),
						'section' 	=> 'blog_section',
				...
				$wp_customize->add_section( 'single_section' , array(
				    'title' 	=> esc_html__( 'Single', 'remons' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );	
					...
					$wp_customize->add_control('blog_single_show_tag', array(
						'label' 	=> esc_html__('Show Tag','remons'),
						'section' 	=> 'single_section',
					...
					$wp_customize->add_control('blog_single_show_share_social_icon', array(
						'label' => esc_html__('Show Share Social Icon','remons'),
						'section' => 'single_section',
					...
					$wp_customize->add_control('blog_single_show_next_prev_post', array(
						'label' => esc_html__('Show Next Prev','remons'),
						'section' => 'single_section',
	    ...
	    public function remons_init_ova_woo( $wp_customize ){
			...
			$wp_customize->add_control('woo_archive_display', array(
				'label'    => esc_html__('Shop products display','remons'),
				'section'  => 'woocommerce_product_catalog',
				'settings' => 'woo_archive_display',
				'type'     =>'select',
				'choices'  => array(
					'all' => esc_html__('All products', 'remons'),
			...
			$wp_customize->add_control('woo_archive_layout', array(
				'label'    => esc_html__('Archive Layout','remons'),
				'section'  => 'woocommerce_product_catalog',
				'settings' => 'woo_archive_layout',
				'type'     =>'select',
				'choices'  => array(
					'woo_layout_1c' => esc_html__('No Sidebar', 'remons'),
					'woo_layout_2r' => esc_html__('Right Sidebar', 'remons'),
					'woo_layout_2l' => esc_html__('Left Sidebar', 'remons'),
				)
			));
			...
			$wp_customize->add_control('woo_archive_header', array(
				...
				'type' 		=>'select',
				'choices' 	=> apply_filters('remons_list_header', '')
			));
			...
			$wp_customize->add_control('woo_archive_footer', array(
				...
				'type' 		=>'select',
				'choices' 	=> apply_filters('remons_list_footer', '')
			));
	    	...
	    	$wp_customize->add_control('woo_archive_show_title', array(
	    		'label'    	=> esc_html__('Show/Hide Title','remons'),
	    		'section'  	=> 'woocommerce_product_catalog',
			...
			$wp_customize->add_section( 'product_detail' , array(
			    'title' 	=> esc_html__( 'Product detail', 'remons' ),
			    'priority' 	=> 30,
			    'panel' 	=> 'woocommerce',
			) );
			...
			$wp_customize->add_control('woo_product_layout', array(
				'label'    => esc_html__('Single Layout','remons'),
