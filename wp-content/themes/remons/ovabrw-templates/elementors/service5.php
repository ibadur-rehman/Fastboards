...
$text_discount = remons_get_meta_data( 'text_discount', $args );
$text_button = remons_get_meta_data( 'text_button', $args );
$text_price = remons_get_meta_data( 'text_price', $args );
...
<div class="remons-service template5">
    <?php if ( $discount_badge ): ?>
      	<p class="discount-badge"><?php echo esc_html( $discount_badge ); ?></p>
    <?php endif; ?>
    ...
    <?php if ( $text_price ): ?>
      	<p class="price"><?php echo wp_kses_post( $text_price ); ?></p>
    <?php endif; ?>
