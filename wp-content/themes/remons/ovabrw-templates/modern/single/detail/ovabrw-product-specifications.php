...
if ( remons_array_exists( $product_specifications ) ): ?>
		...
		?>
			<li class="item-specification">
				...
				<?php elseif ( 'color' === $type ): ?>
					<span class="specification-color" style="display: inline-block; width: 20px; height: 10px; background-color: <?php echo esc_attr( $value ) ?>;"></span>
